...
{ "ER_VERS_ENGINE_UNSUPPORTED", 4111, "Transaction system versioning for %`s is not supported" },
...
{ "ER_VERS_NOT_SUPPORTED", 4138, "%s is not supported for %s system-versioned tables" },
